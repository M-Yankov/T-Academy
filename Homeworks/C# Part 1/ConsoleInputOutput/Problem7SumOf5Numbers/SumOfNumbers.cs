...
class SumOfNumbers
{
    static void Main()
    {
            ...
            //it use some variable (in this case: s) to take tour around each substring in this array 
        {
            ...
            if (s.Trim() != "")//Trim method deletes white spaces (intervals) before and after subtring 
            {
                if (s.Equals(splited.Last()))//if it's last substring in array --> http://stackoverflow.com/questions/7476174/foreach-loop-determine-which-is-the-last-iteration-of-the-loop
                {
