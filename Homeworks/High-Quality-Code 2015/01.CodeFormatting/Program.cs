...
// I not agree that: all classes myst be placed after all methods -- StyleCop
// When parameters in method are on separate lines, the first one must begin on same line. - This is my convention. StyleCop says different
// Also I will not rename variables where StyleCop says that are with Hungarian notation.
// I separate asigning variables from methods with one break line. Example:
/* int a = 5;
 * string text = "Hello World";
 * DateTime oldDate = new Date(2001, 1, 1);
 * 
 * public static void Calculate(string text, int number)
 * {
 *      return ;
 * }
