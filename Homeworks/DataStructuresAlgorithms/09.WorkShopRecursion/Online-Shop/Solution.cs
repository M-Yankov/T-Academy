...
public class ShoppingCenter
{
    public static void Main()
    {
        ...
        //CommandProcessor center = new CommandProcessor();
...
{
    private static string PRODUCT_ADDED = "Product added";
    private static string X_PRODUCTS_DELETED = " products deleted";
    private static string NO_PRODUCTS_FOUND = "No products found";
    private static string INCORRECT_COMMAND = "Incorrect command";

    private static MultiDictionary<string, Product> productsByName = new MultiDictionary<string, Product>(true);
    private static MultiDictionary<string, Product> nameAndProducer = new MultiDictionary<string, Product>(true);
    ...
    private static string FindProductsByPriceRange(string from, string to)
    {
    ...
    private static string FormatProductForPrint(ICollection<Product> products)
    {
