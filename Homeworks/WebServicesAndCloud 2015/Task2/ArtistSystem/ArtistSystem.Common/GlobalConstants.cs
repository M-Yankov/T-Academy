namespace ArtistSystem.Common
{
    public class GlobalConstants
    {
        ...
        public const int GenreMinLength = GlobalTextMinLength;
        public const int GenreMaxLength = GlobalTextMaxLength;
        public const int NameMinLength = GlobalTextMinLength;
        public const int NameMaxLenngth = GlobalTextMaxLength;
